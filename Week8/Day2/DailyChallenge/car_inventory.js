...
//Create a function sortCarInventoryByYear(carInventory) that takes a single parameter. carInventory
//the function should return an inventory that is sorted by car_year, ascending.
function sortCarInventoryByYear(carInventory){
    return carInventory.sort(compare);
}

const compare = (car1, car2) => car1.car_year - car2.car_year;
